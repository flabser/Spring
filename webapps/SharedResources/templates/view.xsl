		...
		<xsl:choose>
			<xsl:when test="$maxpage>15">
				<xsl:choose>
					<xsl:when test="$maxpage - $currentpage &lt; 15">
						...
						<xsl:if test="$currentpage != $maxpage">
							<xsl:if test="$i = $n+1">
								<td>
									<a href="">
										<xsl:attribute name="href">javascript:updateView(&quot;<xsl:value-of select="@id"/>&quot;,&quot;<xsl:value-of select="query/@direction"/>&quot;,<xsl:value-of select="$nextpage" />)</xsl:attribute>
								...
								<td>
									<a href="">
										<xsl:attribute name="href">javascript:updateView(&quot;<xsl:value-of select="@id"/>&quot;,&quot;<xsl:value-of select="query/@direction"/>&quot;,<xsl:value-of select="$maxpage" />)</xsl:attribute>
										<font style="font-size:12px"> >> </font>
									</a>
									&#xA0;
					...
					<xsl:otherwise>
						<xsl:if test="$i != $n+1">
							<xsl:if test="$c &lt; $maxpage + 1">
								<td>
									<a href="">
										<xsl:attribute name="href">javascript:updateView(&quot;<xsl:value-of select="@id"/>&quot;,&quot;<xsl:value-of select="query/@direction"/>&quot;,<xsl:value-of select="$c" />)</xsl:attribute>
										<font style="font-size:12px">
			...
			<xsl:otherwise>
				<xsl:if test="$i != $n+1">
					<xsl:if test="$i &lt; $maxpage + 1">
						<td>
							<a href="">
								<xsl:attribute name="href">javascript:updateView(&quot;<xsl:value-of select="@id"/>&quot;,&quot;<xsl:value-of select="query/@direction"/>&quot;,<xsl:value-of select="$i"/>)</xsl:attribute>
								<font style="font-size:12px">
			...
			<xsl:when test="$maxpage > 10">
				<xsl:choose>
					...
					<xsl:otherwise>
						<td>
							<a href="">
								<xsl:attribute name="href">javascript:updateView(&quot;<xsl:value-of select="@id"/>&quot;,'forward',<xsl:value-of select="$nextpage"/>)</xsl:attribute>
								>
							</a>
							&#xA0;
						</td>
						<td>
							<a href="">
								<xsl:attribute name="href">javascript:updateView(&quot;<xsl:value-of select="@id"/>&quot;,'forward',<xsl:value-of select="$maxpage"/>)</xsl:attribute>
								>>
							</a>
							&#xA0;
						</td>
