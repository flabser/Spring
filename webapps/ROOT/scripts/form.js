...
function changePassword(ParentObj){
	...
	newElem+="<font style='font-size:12px; text-decoration:underline ; color:blue; cursor:pointer' onclick='javascript:cancelChangePassword(this)'>Cancel</font>"
	newElem+="<font style='font-size:12px; margin-left:10px; text-decoration:underline ; color:blue; cursor:pointer' onclick='javascript:okChangePassword(this)'>Ok</font>"
	newElem+="</td></tr>";
...
function cancelChangePassword(ParentObj){
	...
	newElem="<font style='font-size:12px; margin-left:2%; text-decoration:underline ; color:blue; cursor:pointer' onclick='javascript:changePassword(this)'>Change password</font>"
...
function addFieldToRule(){
	...
	newelem+="<td><input type='text' id='publishas' style='width:100%'/></td></tr>"
...
function saveUser() {		
	...
	$.ajax({
		type: "POST",
		url: "Provider?type=save&element=user",
		data: formData,
		beforeSend: function(){
			if ($("#pwd1").val() != $("#pwd2").val() || $("#pwd1").val().length == 0 || $("#pwd2").val().length == 0){
				alert("Your password do not match. Please try again.")
