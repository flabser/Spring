...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="/request">
		<head>
			<title>
				Пользователь 	&#xA0;-<xsl:value-of select="document/userid"/>
			</title>
		...
		<body>
				...
				<div style="background:#686662; height:50px;  padding:10px 0px 0px 20px">
					...
					<div style="height:20px; padding-top:15px; padding-left:5px">
						...
						<a class="btn">
							...
							<font style="font-size:13px;  text-decoration:none">Сохранить &amp; Закрыть</font>
						</a>
			...
			<br/>
			<br/>
			<font style="font-family:corbel; font-size:25px; margin-left:15px">	Пользователь :&#xA0;</font>
			...
			<form action="Provider" method="post" id="scriptest" enctype="application/x-www-form-urlencoded">
				<table border="0" style="margin-top:30px;width:100%">
					<tr>
						<td class="fc" style="color:#686662; font-size:12px; vertical-align:middle">UserID :&#xA0;</td>
						<td>
							<input type="text" name="userid" style="width:300px; padding:5px" value="{document/userid}"/>
						</td>
					</tr>
					<tr>
						<td class="fc" style="color:#686662; font-size:12px; vertical-align:middle">E-mail :&#xA0;</td>
						<td>
							<input type="text" name="email" style="width:300px; padding:5px" value="{document/email}"/>
						</td>
					</tr>
					<tr>
						<td class="fc" style="color:#686662; font-size:12px; vertical-align:middle">Пароль :&#xA0;</td>
						<td>
							<input type="password" name="oldpwd" id="pwd1" style="width:300px; padding:5px" value="{document/password}"/>
							&#xA0;
						</td>
					</tr>
					<tr>
						<td class="fc" style="color:#686662; font-size:12px; vertical-align:middle">Подтвердите пароль :&#xA0;</td>
						<td>
							<input type="password" name="pwd" id="pwd2" style="width:300px; padding:5px" value="{document/password}"/>
							&#xA0;
						</td>
					</tr>
